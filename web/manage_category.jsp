<%-- 
    ...
    Created on : Aug 26, 2019, 12:13:21 PM
    Author     : Loi Nguyen
--%>
...
<html>
    ...
    <body>
        ...
        <div class="float-left">
            ...
            <div class="menu-title-selected"><i class="fas fa-list-alt"></i> Manage Category</div>
        ...
        <div class="float-right">
            <div id="tab-bar">
                <s:url action="manage-category" var="list">
                    <s:param name="action" value="'list'"/>
                </s:url>
                <s:url action="manage-category" var="add">
                ...
                <div class="tab">
                    <s:form action="manage-category" theme="simple" method="GET">
                        ...
                        <s:iterator value="list" status="counter" >
                            <tr>
                                ...
                                <td>
                                    ...
                                    <s:form action="manage-category" method="POST">
                                    ...
                                    <s:form action="category-action" method="POST">
                                        <s:hidden name="categoryID" value="%{categoryID}"/>
            ...
            <s:elseif test="%{action == 'add'}">
                <div class="checkbox">
                    <s:form action="category-action" method="POST">
                        <s:textfield name="categoryName" label="Tên Danh mục"/>
            ...
            <s:elseif test="%{action == 'edit'}">
                <div class="checkbox">
                    <s:form action="category-action" method="POST">
                        <s:textfield name="categoryName" label="Tên Danh Mục" value="%{dto.categoryName}"/>
                        <s:select name="status" label="Trạng thái" value="%{dto.status}" list="{'True','False'}"/>
                        <s:hidden name="categoryID" value="%{dto.categoryID}"/>
                        <s:hidden name="action" value="edit"/>
                        <s:submit value="Thêm" cssClass="basic"/>
                    </s:form>    
                </div>
